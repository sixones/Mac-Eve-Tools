...
@interface METFittingController ()

@end

@implementation METFittingController

+(void) displayFitting:(METFitting *)fit forCharacter:(Character *)ch
{
#ifndef __clang_analyzer__
    METFittingController *wc = [[METFittingController alloc] initWithFitting:fit forCharacter:ch];
